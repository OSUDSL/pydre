...
class MainWindow(Window):
    ...
    def handle_saveas(self, idx=None):
        ...
        fileName = QFileDialog.getOpenFileName(
            self, "Save project file as...", "", "project files (*.json)"
        )
    ...
    def handle_run(self):
        ...
        if self.ui.ofile_inp.text().strip():
            ...
            def cb(e):
                return self.run_pydre() if e else None
    ...
    def to_start(self):
        ...
        width, height = self.screen_width / 3.0, self.screen_height / 2.5
    ...
    def to_editor(self):
        ...
        width, height = self.screen_width / 2.5, self.screen_height / 2.0
        self.resize_and_center(width, height)
