...
**NOTE: Time Ranges are formatted as hh:mm:ss-hh:mm:ss#driveID If multiple drives are used in a praticular ROI, simply add a space and write in another time range in the same cell**
