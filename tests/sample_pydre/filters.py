...
def numberSwitchBlocks(drivedata: tests.sample_pydre.core.DriveData,):
    copy = tests.sample_pydre.core.DriveData.__init__(drivedata, drivedata.PartID, drivedata.DriveID, drivedata.roi,
...
def smoothGazeData(drivedata: tests.sample_pydre.core.DriveData, timeColName: str = "DatTime",
